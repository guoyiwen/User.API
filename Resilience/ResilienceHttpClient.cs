...
namespace Resilience
{
    public class ResilienceHttpClient : IHttpClient
    {
        ...
        public ResilienceHttpClient(string applicationName, Func<string, IEnumerable<IAsyncPolicy>> policyCreator, ILogger<ResilienceHttpClient> logger, IHttpContextAccessor httpContextAccessor)
        {
